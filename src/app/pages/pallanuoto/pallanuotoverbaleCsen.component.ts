...
@Component({
  selector: 'palanuotoVerbaleCsen',
  templateUrl: './pallanuotoverbaleCsen.component.html',
  styleUrls: ['./pallanuotoverbaleCsen.component.css'],
})
export class PallanuotoVerbaleCsenComponent implements OnInit {
  constructor() {}
  ngOnInit() {}
